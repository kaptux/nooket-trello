...
class NooketTrello extends React.Component {
    constructor() {
        ...
        this.handleCardClick = cardId => {
            ...
            const instanceView = onRequestInstanceView(nooket_common_1.InstanceViewModeEnum.FULLSCREEN, cardId);
            this.setState({ instanceView });
            this.reRenderBoard = false;
        };
        this.handleDragEnd = (cardId, sourceLaneId, targetLaneId, position, cardDetails) => {
    ...
    renderBoard() {
        ...
        this.lastBoardRender = (React.createElement(React.Fragment, null,
            isBoardConfigured && (React.createElement("div", { className: "head" },
                React.createElement("div", { className: "quick-filters" },
                    React.createElement(antd_1.Select, { value: assignedFilter, showSearch: true, style: { width: 200 }, allowClear: true, placeholder: "Assigned to", onChange: value => {
                        ...
                        "\u00A0\u00A0",
                        user.name)))),
                    React.createElement(antd_1.Select, { showSearch: true, style: { width: 200, marginLeft: 10 }, placeholder: "Color", value: colorFilter })),
                React.createElement("div", { className: "toolbox" },
                    React.createElement(antd_1.Button, { icon: "setting", onClick: this.handleSettingClick })))),
            isBoardConfigured && (React.createElement(react_trello_1.default, { data: data, draggable: true, hideCardDeleteIcon: true, onCardClick: this.handleCardClick, handleLaneDragEnd: this.handleLaneDragEnd, handleDragEnd: this.handleDragEnd, newCardTemplate: React.createElement(NewCardFormTemplate_1.default, null), customCardLayout: true, className: "boardContainer" },
